...
<div class="container" style="margin-top: 20px;">
	<table class="table">
		...
		<tbody>
			...
			<tr>
				<th style="background-color: hotpink; vertical-align: middle;">나이</th>
				<td>
			...
			<tr>
				<th style="background-color: hotpink; vertical-align: middle;">성별</th>
				<td>
			...
			<tr>
				<th style="background-color: hotpink; vertical-align: middle;">이메일</th>
				<td>
			...
			<tr class="warning">
				<td colspan="2">
					<input class="btn btn-warning pull-right" type="button" value="입력하기"
